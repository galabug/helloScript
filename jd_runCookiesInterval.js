...
console.log(`fileName=${fileName}, onceRunNum=${onceRunNum}, thisTime=${thisTime}, type=${runType}`);
...
async function sleep(timeout) {
  ...
  console.log('睡眠' + (timeout / 60000) + '分钟')
